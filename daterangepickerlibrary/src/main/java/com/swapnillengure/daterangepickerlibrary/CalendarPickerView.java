...
public class CalendarPickerView extends RecyclerView {
    ...
    public CalendarPickerView(Context context, AttributeSet attrs) {
        ...
        dividerColor = a.getColor(R.styleable.CalendarPickerView_tsquare_dividerColor,
                res.getColor(R.color.transferent));
        ...
        setBackground(ContextCompat.getDrawable(context,R.drawable.calender));
    ...
    private class MonthAdapter extends Adapter<MonthAdapter.MyHolder> {
